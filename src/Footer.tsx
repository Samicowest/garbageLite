    ...
    <div id="contact" className="bg-black p-10 mt-16">
      <div className="flex justify-between flex-col md:flex-row items-start w-full ">
        <div className="flex flex-col gap-4 my-8">
          ...
          <h2
            className="text-slate-200 font-extrabold text-2xl"
            onClick={handleButtonClick}
          >
            Search Hub
          </h2>
          <p className="text-slate-200">
            <b>Office Address:</b> 218, Osuntokun Avenue, Ibadan, Nigeria
          </p>
        </div>
        <div className="grid w-full md:w-[65%] grid-cols-2 xxm:grid-cols-3 ">
          ...
          <div className="">
            ...
            <div className="flex flex-col text-white py-4 gap-2">
              <span className="text-md md:text-xl">Privacy Policy</span>
              <span className="text-md md:text-xl">Terms and Conditions</span>
              <span className="text-md md:text-xl">Contact Us</span>
            </div>
          </div>
          <div className="">
            <h2 className="font-bold text-md md:text-xl lg:text-2xl text-white">
            ...
            <div className="flex flex-col text-white py-4 gap-2">
              <span className="text-md md:text-xl">
                Support@garbagelite.com
              </span>
              <span className="text-md md:text-xl">
                218, Osuntokun Avenue, Ibadan, Nigeria.
              </span>
      ...
      <div className="text-center text-white font-bold text-md md:text-xl mt-16 mb-2">
        2024 | GarbageLitee
      </div>
    </div>
  );
